...
public class JHipsterProperties {
    ...
    public static class Mail {
        ...
        private String from = "TrainingApp@localhost";
    ...
    public static class Swagger {
        ...
        private String title = "TrainingApp API";

        private String description = "TrainingApp API documentation";
    ...
    public static class Metrics {
        ...
        public static class Graphite {
            ...
            private String prefix = "TrainingApp";
